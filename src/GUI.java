...
public class GUI extends JPanel implements ActionListener, ChangeListener {
	 ...
	 */
	public void initialize(Container container1) {
		...
		startRain = new JButton("Toggle rain simulation");
		startRain.setActionCommand("StartRain");
		startRain.addActionListener(this);
